...
- (void)imageWithImageUrl:(NSString*)imageUrl placeholderImage:(UIImage*)placeholderImage
{
    [self sd_setImageWithURL:[imageUrl lkbImageUrl] placeholderImage:placeholderImage];
    [self setNeedsLayout];
}
