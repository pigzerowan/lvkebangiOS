...
- (void)configireTabPropertys
{
    ...
    _selectedTextFont = [UIFont systemFontOfSize:14];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if (_cellWidth > 0) {
        ...
        if (iPhone5) {
            ...
            CGFloat width = [self boundingSizeWithString:title font:_selectedTextFont constrainedToSize:CGSizeMake(300, 100)].width+_cellEdging*10;
            return CGSizeMake(width, CGRectGetHeight(_collectionViewBar.frame));

        }
        else if (iPhone6p) {
            CGFloat width = [self boundingSizeWithString:title font:_selectedTextFont constrainedToSize:CGSizeMake(300, 100)].width+_cellEdging*12;
            return CGSizeMake(width, CGRectGetHeight(_collectionViewBar.frame));
