...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
        ...
        _normalTextColor = CCCUIColorFromHex(0x999999);
        _selectedTextColor = [UIColor LkbgreenColor];
        
        _pagerBarColor = [UIColor whiteColor];
        _collectionViewBarColor = [UIColor clearColor];
        
        _progressColor = [UIColor LkbgreenColor];
...
- (void)setBarStyle:(TYPagerBarStyle)barStyle
{
    ...
    if (barStyle == TYPagerBarStyleCoverView) {
        ...
        self.progressColor = [UIColor LkbgreenColor];
    }
