...
- (void)setupToolbars
{
    ...
    indexLabel.textColor = CCCUIColorFromHex(0xffffffcc);
...
//    indexLabel.backgroundColor = CCCUIColorFromHex(0xffffffcc);

    indexLabel.bounds = CGRectMake(18, 18, 80, 30);
    indexLabel.center = CGPointMake(23, 30);
...
//    [saveButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [saveButton setImage:[UIImage imageNamed:@"downloadPic"] forState:UIControlStateNormal];
...
//    _scrollView.center = self.center;
    ...
    _indexLabel.bounds = CGRectMake(18, 18, 80, 30);
    _indexLabel.center = CGPointMake(23, 30);
    _saveButton.frame = CGRectMake(18, self.bounds.size.height - 36, 22, 22);
}
...
- (void)showFirstImage
{
    ...
    if(placeImageSizeH == 0||placeImageSizeH==0)
    {
