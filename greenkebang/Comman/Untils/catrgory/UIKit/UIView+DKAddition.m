...
{
    if (top) {
        [self addUpperBorder:UIRectEdgeTop color:color thickness:1.0f];
    }
    if (bottom) {
        [self addUpperBorder:UIRectEdgeBottom color:color thickness:1.0f];
    }
    if (left) {
        [self addUpperBorder:UIRectEdgeLeft color:color thickness:1.0f];
    }
    if (right) {
        [self addUpperBorder:UIRectEdgeRight color:color thickness:1.0f];
    }
}
