...
NSInteger SolarToInt(NSInteger y, NSInteger m, NSInteger d)
{
    m = (m + 9) % 12;
    y = y - m / 10;
...
+ (Solar*)SolarFromInt:(NSInteger)g
{
...
{
    NSInteger days = lunar_month_days[lunar.lunarYear - lunar_month_days[0]];
    ...
    NSInteger solar11 = solar_1_1[lunar.lunarYear - solar_1_1[0]];
...
+ (Lunar*)solarToLunar:(Solar*)solar;
{
    ...
    NSInteger index = solar.solarYear - solar_1_1[0];
    NSInteger data = (solar.solarYear << 9) | (solar.solarMonth << 5) | (solar.solarDay);
    NSInteger solar11 = 0;
    ...
    NSInteger m = GetBitInt(solar11, 4, 5);
    NSInteger d = GetBitInt(solar11, 5, 0);
    NSInteger offset = SolarToInt(solar.solarYear, solar.solarMonth, solar.solarDay) - SolarToInt(y, m, d);
