...
{
    NSString *uaStr = [NSString stringWithFormat:@"appName/Dangke,systemName/%@,systemVersion/%@,deviceVersion/%@",[self deviceSystemName],[self deviceSystemVersion],[self deviceVersion]];
    return uaStr;
}
