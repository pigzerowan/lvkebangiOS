...
NSString* const kActivityShareTitle = @"分享到平台";
...
{
    /*
    NSArray *shareTitles = @[@"微信朋友圈",@"微信好友",@"新浪微博",@"QQ",@"QQ空间",@"短信"];
    NSArray *images = @[[UIImage imageNamed:@"shareicon_01.png"],
                        [UIImage imageNamed:@"shareicon_02.png"],
                        [UIImage imageNamed:@"shareicon_03.png"],
                        [UIImage imageNamed:@"shareicon_04.png"],
                        [UIImage imageNamed:@"shareicon_05.png"],
                        [UIImage imageNamed:@"shareicon_06.png"],
                        ];
    NSArray *shareNames = @[UMShareToWechatTimeline,UMShareToWechatSession,UMShareToSina,UMShareToQQ,UMShareToQzone,UMShareToSms];
    if (![WXApi isWXAppInstalled]) {
        shareTitles = @[@"新浪微博",@"QQ",@"QQ空间",@"短信"];
        images = @[ [UIImage imageNamed:@"shareicon_03.png"],
                    [UIImage imageNamed:@"shareicon_04.png"],
                    [UIImage imageNamed:@"shareicon_05.png"],
                    [UIImage imageNamed:@"shareicon_06.png"],
                    ];
        shareNames = @[UMShareToSina,UMShareToQQ,UMShareToQzone,UMShareToSms];
    }
    */
    ...
    if ([WXApi isWXAppInstalled]) {
     ...
     BOOL isSinaInstalled = [[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString: @"sinaweibo://"]];
    if (isSinaInstalled) {
        [shareTitles addObject:@"新浪微博"];
        [shareNames addObject:UMShareToSina];
        [images addObject:[UIImage imageNamed:@"shareicon_03.png"]];
    }
