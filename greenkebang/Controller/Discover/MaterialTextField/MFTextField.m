...
static CGFloat const MFDefaultLabelFontSize = 10.0f;
...
- (void)updateUnderlineFrame
{
    ...
    self.underlineLayer.frame = CGRectMake(0, yPos, CGRectGetWidth(self.bounds), 0.5);
...
{
    CGFloat topPadding = CGRectGetMaxY(self.underlineLayer.frame)-3;
