...
- (void)configUI:(CGRect)frame{
    ...
    barBackV.backgroundColor = CCColorFromRGBA(60, 60, 60, 1.0);
    barBackV.layer.shadowOffset = CGSizeMake(0, - 4.f);
    barBackV.layer.shadowColor = CCColorFromRGBA(198.f, 198.f, 198.f, 1).CGColor;
    ...
    for (NSUInteger i = 0; i < imgArr.count; i++) {
        ...
        NSInteger leftWidth= (kDeviceWidth / 5 - 50)/2;
