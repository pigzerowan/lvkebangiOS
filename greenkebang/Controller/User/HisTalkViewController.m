...
@interface HisTalkViewController ()<UserHeaderViewDelegate>
...
@implementation HisTalkViewController
              ...
              errorMessage:(NSString *)errorMessage
{
    ...
    if ([request.url isEqualToString:LKB_His_Topic_Url]) {
        ...
        if (!request.isLoadingMore) {
            ...
            if (topicModel.data.count<10) {
               PeoplestopicModel *topic1 = (PeoplestopicModel *)_dataArray.lastObject;
                PeoplestopicModel *topic2 = (PeoplestopicModel *)topicModel.data.lastObject;
                
                NSLog(@"==========%@==============",topic1.topicId);
                NSLog(@"==========%@=====xxxx222=========",topic2.topicId);
                if ([ topic1.topicId isEqualToString:topic2.topicId]) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    myLable.text = [NSString stringWithFormat:@"%@的话题",[ToUserManager shareInstance].userName];
    return headerView;
}
...
- (void)fetchDataWithIsLoadingMore:(BOOL)isLoadingMore
{
    ...
    if (!isLoadingMore) {
        ...
        self.requestURL = LKB_His_Topic_Url;
...
//    appDelegate.window.rootViewController =[TabbarManager shareInstance].lkbbaseVc;
//  [ self.tabBarController.navigationController popToRootViewControllerAnimated : YES ];
