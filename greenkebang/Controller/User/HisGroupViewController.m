...
@interface HisGroupViewController ()<UserHeaderViewDelegate>
...
@implementation HisGroupViewController
...
//        return;
//    }
//    if ([request.url isEqualToString:LKB_His_Group_Url]) {
//        GroupModel *topicModel = (GroupModel *)parserObject;
//        if (!request.isLoadingMore) {
...
//                GroupDetailModel *topic1 = (GroupDetailModel *)_dataArray.lastObject;
////                GroupDetailModel *topic2 = (GroupDetailModel *)topicModel.data.lastObject;
//                
//                NSLog(@"==========%@==============",topic1.groupId);
//                NSLog(@"==========%@=====xxxx222=========",topic2.groupId);
//                if ([ topic1.groupId isEqualToString:topic2.groupId]) {
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    if (indexPath.row < self.dataArray.count) {
        GroupDetailModel *topic = (GroupDetailModel *)_dataArray[indexPath.row];
        [simplescell configUserInforGroupCellWithModel:topic];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    myLable.text = [NSString stringWithFormat:@"%@的群组",[ToUserManager shareInstance].userName];
    return headerView;
}
...
- (void)fetchDataWithIsLoadingMore:(BOOL)isLoadingMore
{
    ...
    self.requestURL = LKB_His_Group_Url;
