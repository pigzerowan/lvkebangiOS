...
#import "UserNewTimeTableViewCell.h"
#import <UIImageView+WebCache.h>
#import "NSDate+TimeAgo.h"
#import "NSDate+TimeInterval.h"
@interface UserNewTimeTableViewCell ()

@property (nonatomic, assign) BOOL isExpandedNow;

@end
@implementation UserNewTimeTableViewCell
...
//        }];
        ...
        [_coverImageView mas_makeConstraints:^(MASConstraintMaker* make) {
            make.right.mas_equalTo(self.contentView.right).offset(-12);
            make.top.mas_equalTo(_nameLabel.bottom).offset(18);
