...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIImage *bgImage = [UIImage imageNamed:@"more_background"];
        UIImage *arrowImage = [UIImage imageNamed:@"popover_arrow33"];
...
//    self.bgImageView.frame = CGRectMake(newFrame.origin.x + newFrame.size.width / 2 - 75, newFrame.origin.y + newFrame.size.height - newFrame.size.height/3 + self.arrowImageView.frame.size.height, 150, 210);
    
    self.arrowImageView.frame = CGRectMake(newFrame.origin.x + newFrame.size.width / 2 - 8, newFrame.origin.y + newFrame.size.height - newFrame.size.height/3 +20, 16.5, 10);

    self.bgImageView.frame = CGRectMake( kDeviceWidth -155, newFrame.origin.y + newFrame.size.height - newFrame.size.height/3 + self.arrowImageView.frame.size.height+20, 150,86);
...
- (void)setContentController:(UIViewController *)contentController {
    ...
    contentView.frame = CGRectMake(0, 0, 150,86);
