//
//  TimeThreeImageWithOneCommentCell.m
//  greenkebang
//
...
@implementation TimeThreeImageWithOneCommentCell
...
- (void)configTimeThreeImageWithOneCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configFarmerThreeImageWithOneCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)updateConstraints
{
    ...
    if (!self.didSetupConstraints) {
        ...
        [_goodsDesLabel mas_makeConstraints:^(MASConstraintMaker* make) {
            make.top.mas_equalTo(_headImageView.bottom).offset(12);
            make.left.mas_equalTo(_headImageView);
            make.width.mas_equalTo(self.contentView).offset(-28);
        }];
...
- (void)ThreeImageWithOneCommenthandlerButtonAction:(BottomBuyClickBlock)block {
