...
@implementation TimeNoImageNoCommentCell
...
- (void)configTimeNoImageNoCommentTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configFarmerNoImageNoCommentTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configAttentionTopicNoImageDetailModel:(AttentionContentsListModel *)model{
