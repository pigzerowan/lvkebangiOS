//
//  TimeNoImageWithOneCommentCell.m
//  greenkebang
//
...
@implementation TimeNoImageWithOneCommentCell
...
- (void)configTimeNoImageWithOneCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configFarmerNoImageWithOneCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)NoImageWithOnehandlerButtonAction:(BottomBuyClickBlock)block {
...
- (TTTAttributedLabel *)commentlabel_1 {
    ...
    if (!_commentlabel_1) {
        ...
        _commentlabel_1 = [[TTTAttributedLabel alloc]initWithFrame:CGRectMake(10, 0, kDeviceWidth -40, 30)];
...
//        _commentlabel_1.linkAttributes = [ kCTForegroundColorAttributeName : agreeLabel.textColor, NSUnderlineStyleAttributeName : NSNumber(long: NSUnderlineStyle.StyleSingle.rawValue) ]
        NSMutableDictionary *linkAttributes = [NSMutableDictionary dictionary];
        [linkAttributes setValue:[NSNumber numberWithBool:NO] forKey:(NSString *)kCTUnderlineStyleAttributeName];
        [linkAttributes setValue:(__bridge id)CCCUIColorFromHex(0x999999).CGColor forKey:(NSString *)kCTForegroundColorAttributeName];
        _commentlabel_1.linkAttributes = linkAttributes;
