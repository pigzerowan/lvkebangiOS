//
//  TimeShareArticleWithOneCommentCell.m
//  greenkebang
//
...
@implementation TimeShareArticleWithOneCommentCell
...
- (void)configTimeShareArticleWithOneCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configFarmerShareArticleWithOneCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
    UIImageView *headerImge = [[UIImageView alloc]init];
    [headerImge sd_setImageWithURL:[model.userAvatar lkbImageUrl4] placeholderImage:YQNormalBackGroundPlaceImage];
    [_headImageView setImage:headerImge.image forState:UIControlStateNormal];
...
- (void)ShareArticleWithOneCommenthandlerButtonAction:(BottomBuyClickBlock)block {
