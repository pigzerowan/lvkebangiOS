//
//  TimeOneImageHeightWithOneCommentCell.m
//  greenkebang
//
...
@implementation TimeOneImageHeightWithOneCommentCell
...
//    [_coverListImage sd_setImageWithURL:[model.coverList[0] lkbImageUrlAllCover] placeholderImage:YQNormalBackGroundPlaceImage];
    ...
    CGRect titleSize = [str boundingRectWithSize:CGSizeMake(kDeviceWidth - 35, KDeviceHeight ) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:12]} context:nil];
...
//    [_coverListImage sd_setImageWithURL:[model.coverList[0] lkbImageUrlAllCover] placeholderImage:YQNormalBackGroundPlaceImage];
    ...
    if ([model.starNum isEqualToString:@"0"]) {
        ...
        if (model.userAvatars.count == 4 ){
            ...
            _headerImage_3.hidden = NO;
            _headerImage_4.hidden = NO;
            [_headerImage sd_setImageWithURL:[model.userAvatars[0] lkbImageUrl4] placeholderImage:YQNormalPlaceImage];
            [_headerImage_2 sd_setImageWithURL:[model.userAvatars[1] lkbImageUrl4] placeholderImage:YQNormalPlaceImage];
            [_headerImage_3 sd_setImageWithURL:[model.userAvatars[2] lkbImageUrl4] placeholderImage:YQNormalPlaceImage];
            [_headerImage_4 sd_setImageWithURL:[model.userAvatars[3] lkbImageUrl4] placeholderImage:YQNormalPlaceImage];
...
//        _coverListImage.backgroundColor = [UIColor clearColor];
