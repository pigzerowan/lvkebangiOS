//
//  TimeShareArticleWithCommentCell.m
//  greenkebang
//
...
@implementation TimeShareArticleWithCommentCell
...
- (void)configTimeShareArticleWithCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
    ...
    if ([model.starNum isEqualToString:@"0"]) {
        ...
        [_commentlabel_1 mas_remakeConstraints:^(MASConstraintMaker* make) {
        ...
        [_commentButton_1 mas_remakeConstraints:^(MASConstraintMaker* make) {
...
- (void)configFarmerShareArticleWithCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)ShareArticleWithCommenthandlerButtonAction:(BottomBuyClickBlock)block {
...
- (UILabel*)shareLable
{
    if (!_shareLable) {
        ...
        _shareLable.text = @"这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字这是一段文字";
...
{
    if (!_shareImg) {
        _shareImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"login-textview"]];
