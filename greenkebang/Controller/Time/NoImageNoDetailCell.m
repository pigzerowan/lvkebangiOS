...
@implementation NoImageNoDetailCell
...
- (void)configNoImageNoDetailUserTableCellWithGoodModel:(UserDynamicModelIntroduceModel *)model {
    ...
    self.nameLabel.text =[NSString stringWithFormat:@"%@ |%@",@"话题",model.userName] ;
