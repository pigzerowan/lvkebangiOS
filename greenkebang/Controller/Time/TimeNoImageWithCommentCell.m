...
@implementation TimeNoImageWithCommentCell
...
- (void)updateConstraints
{
    ...
    if (!self.didSetupConstraints) {
        ...
        [_circleNameButton mas_makeConstraints:^(MASConstraintMaker* make) {
            make.top.mas_equalTo(_goodsDesLabel.bottom).offset(11);
            make.left.mas_equalTo(_headImageView);
        ...
        [_goodImageView mas_makeConstraints:^(MASConstraintMaker* make) {
            make.top.mas_equalTo(_goodsDesLabel.mas_bottom).offset(15);
        ...
        [_goodBtn mas_makeConstraints:^(MASConstraintMaker* make) {
            make.top.mas_equalTo(_goodsDesLabel.mas_bottom).offset(0);
        ...
        [_shareBtn mas_makeConstraints:^(MASConstraintMaker* make) {
            ...
            make.top.mas_equalTo(_goodsDesLabel.mas_bottom).offset(8);
