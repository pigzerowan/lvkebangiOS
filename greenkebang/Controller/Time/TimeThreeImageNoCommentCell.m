...
@implementation TimeThreeImageNoCommentCell
...
- (void)configTimeThreeImageNoCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configFarmerThreeImageNoCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configAttentionTopicThreeImageCellTimeNewDynamicDetailModel:(AttentionContentsListModel *)model{
...
- (void)ThreeImageNoCommenthandlerButtonAction:(BottomBuyClickBlock)block {
