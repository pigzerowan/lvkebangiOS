...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        topLine = [[UIView alloc] initWithFrame:CGRectMake(0, self.height2-.5, [UIScreen screenWidth], .5)];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        
        {
            ...
            if (comments) {
                ...
                commentsRect = CGRectMake(x-5, self.height2-50, [UIScreen screenWidth]-x+5, 50);
                x -= 20;
            }
            ...
            if (reposts) {
                ...
                repostsRect = CGRectMake(x-5, self.height2-50, commentsRect.origin.x-x, 50);
                x -= 20;
            }
