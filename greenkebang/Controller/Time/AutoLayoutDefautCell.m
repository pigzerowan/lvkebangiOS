//
//  AutoLayoutDefautCell.m
//  greenkebang
//
//  Created by 郑渊文 on 4/26/16.
...
@interface AutoLayoutDefautCell ()

@property (nonatomic, assign) BOOL isExpandedNow;

@end
@implementation AutoLayoutDefautCell
...
- (UILabel*)nameLabel
{
    if (!_nameLabel) {
        ...
        _nameLabel.textColor = [UIColor colorWithHex:0x999999];
