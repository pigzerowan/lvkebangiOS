//
//  TimeOneImageHeightWithCommentCell.m
//  greenkebang
//
...
@implementation TimeOneImageHeightWithCommentCell
...
//    [_coverListImZZage sd_setImageWithURL:[model.coverList[0] lkbImageUrlAllCover] placeholderImage:YQNormalBackGroundPlaceImage];
...
//    [_coverListImage sd_setImageWithURL:[model.coverList[0] lkbImageUrlAllCover] placeholderImage:YQNormalBackGroundPlaceImage];
    ...
    if (model.imageInfo == nil) {
        ...
        [coverImage sd_setImageWithURL:[model.coverList[0] lkbImageUrlAllCover] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        ...
        NSDictionary *jsonStr = [NSJSONSerialization JSONObjectWithData:jsonData options:NSJSONReadingMutableLeaves error:&error];
        NSLog(@"++++++++++++++++++++++++++++++%@",jsonStr);
        width = [[jsonStr objectForKey:@"width"] floatValue];
        height = [[jsonStr objectForKey:@"height"] floatValue];
    }
