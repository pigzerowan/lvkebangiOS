...
@implementation TimeTwoImageWithCommentCell
...
- (void)configTimeTwoImageWithCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)configFarmerTwoImageWithCommentCellTimeNewDynamicDetailModel:(NewDynamicDetailModel *)model {
...
- (void)TwoImageWithCommenthandlerButtonAction:(BottomBuyClickBlock)block {
