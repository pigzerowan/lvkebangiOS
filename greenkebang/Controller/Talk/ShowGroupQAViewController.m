...
@interface ShowGroupQAViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (strong, nonatomic) UITableView* tableView;
@property (strong, nonatomic) NSMutableArray* dataArray;
@end
@implementation ShowGroupQAViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"查看问答";
    ...
    [senderBtn addTarget:self action:@selector(turnToSendQA:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)fetchDataWithIsLoadingMore:(BOOL)isLoadingMore
{
    ...
    self.requestURL = LKB_Group_QA_Url;
              ...
              errorMessage:(NSString *)errorMessage
{
    ...
    if ([request.url isEqualToString:LKB_Group_QA_Url]) {
...
//        qadetailVC.questionId = newDynamicModel.questionDesc;
