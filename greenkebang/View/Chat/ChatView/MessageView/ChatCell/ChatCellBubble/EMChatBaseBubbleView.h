...
#define BUBBLE_LEFT_IMAGE_NAME @"chat_receiver_bgshare" // bubbleView 的背景图片
#define BUBBLE_RIGHT_IMAGE_NAME @"chat_sender_bgshare"


#define BUBBLE_LEFT_IMAGE_NAMESHARE @"share_receiver_bg" // bubbleView 的背景图片
#define BUBBLE_RIGHT_IMAGE_NAMESHARE @"share_sender_bg"
