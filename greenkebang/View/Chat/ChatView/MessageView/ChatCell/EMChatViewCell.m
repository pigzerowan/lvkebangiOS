...
-(void)layoutSubviews
{
    ...
    if (self.messageModel.isSender) {
        ...
        bubbleFrame.origin.x = 10 * 2 + HEAD_SIZE;
...
- (EMChatBaseBubbleView *)bubbleViewForMessageModel:(MessageModel *)messageModel
{
    ...
    switch (messageModel.type) {
        case eMessageBodyType_Text:
        {
            ...
            if (![[messageModel.message.ext allKeys] containsObject:@"shareType"]) {
            ...
            {
                return [[CustomChatShareBubbleView alloc] init];
            }
...
//    return MAX(headHeight, bubbleHeight + NAME_LABEL_HEIGHT + NAME_LABEL_PADDING) + CELLPADDING;
    return MAX(headHeight, bubbleHeight + NAME_LABEL_PADDING);
