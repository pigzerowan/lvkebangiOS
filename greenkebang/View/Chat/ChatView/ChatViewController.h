...
@property (strong, nonatomic) NSMutableArray *secretArray;
...
@property (nonatomic) BOOL ifShare;
...
-(void)sendShareMessage:(NSString *)shareModle withIfShare:(NSString *)ifshare;
